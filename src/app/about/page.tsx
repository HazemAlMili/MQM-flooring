...
export const metadata: Metadata = {
  title: "About Us | Maqam Al-Emaar",
  description:
    "Learn about our history, mission, and vision in delivering premium construction and fit-out solutions across the Middle East.",
  openGraph: {
    title: "About Us | Maqam Al-Emaar",
    description:
      "Learn about our history, mission, and vision in delivering premium construction and fit-out solutions across the Middle East.",
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <AnimatedSection>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-primary font-semibold rounded-xl hover:bg-white/90 transition-colors shadow-btn"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Contact Us Today
